...
void protobuf_AddDesc_google_2fprotobuf_2funittest_5fmset_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "\007type_id\030\002 \002(\005\022\017\n\007message\030\003 \002(\014B)H\001\370\001\001\252\002"
    "!Google.ProtocolBuffers.TestProtos", 634);
...
TestMessageSet::TestMessageSet()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:protobuf_unittest.TestMessageSet)
}
...
TestMessageSet::TestMessageSet(::google::protobuf::Arena* arena)
  ...
  // @@protoc_insertion_point(arena_constructor:protobuf_unittest.TestMessageSet)
}
...
TestMessageSet::TestMessageSet(const TestMessageSet& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:protobuf_unittest.TestMessageSet)
}
...
TestMessageSet::~TestMessageSet() {
  // @@protoc_insertion_point(destructor:protobuf_unittest.TestMessageSet)
  SharedDtor();
}
...
void TestMessageSetContainer::_slow_mutable_message_set() {
  message_set_ = ::google::protobuf::Arena::CreateMessage< ::protobuf_unittest::TestMessageSet >(
        GetArenaNoVirtual());
}
::protobuf_unittest::TestMessageSet* TestMessageSetContainer::_slow_release_message_set() {
  if (message_set_ == NULL) {
    return NULL;
  } else {
    ::protobuf_unittest::TestMessageSet* temp = new ::protobuf_unittest::TestMessageSet;
    temp->MergeFrom(*message_set_);
    message_set_ = NULL;
    return temp;
  }
}
::protobuf_unittest::TestMessageSet* TestMessageSetContainer::unsafe_arena_release_message_set() {
...
void TestMessageSetContainer::_slow_set_allocated_message_set(
    ...
    if (message_arena != NULL && 
      ...
      ::protobuf_unittest::TestMessageSet* new_message_set = 
            ::google::protobuf::Arena::CreateMessage< ::protobuf_unittest::TestMessageSet >(
            message_arena);
...
void TestMessageSetContainer::clear_message_set() {
 ...
 const ::protobuf_unittest::TestMessageSet& TestMessageSetContainer::message_set() const {
 ...
 ::protobuf_unittest::TestMessageSet* TestMessageSetContainer::mutable_message_set() {
  set_has_message_set();
  if (message_set_ == NULL) {
 ...
 ::protobuf_unittest::TestMessageSet* TestMessageSetContainer::release_message_set() {
  clear_has_message_set();
  if (GetArenaNoVirtual() != NULL) {
 ...
 void TestMessageSetContainer::set_allocated_message_set(::protobuf_unittest::TestMessageSet* message_set) {
