...
void protobuf_AddDesc_google_2fprotobuf_2fmap_5funittest_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "\"\344\001\n\037MessageContainingEnumCalledType\022J\n\004"
    "type\030\001 \003(\0132<.protobuf_unittest.MessageCo"
    "ntainingEnumCalledType.TypeEntry\032_\n\tType"
    "Entry\022\013\n\003key\030\001 \001(\005\022A\n\005value\030\002 \001(\01322.prot"
    "obuf_unittest.MessageContainingEnumCalle"
    "dType:\0028\001\"\024\n\004Type\022\014\n\010TYPE_FOO\020\000\"\235\001\n\037Mess"
    "ageContainingMapCalledEntry\022L\n\005entry\030\001 \003"
    "(\0132=.protobuf_unittest.MessageContaining"
    "MapCalledEntry.EntryEntry\032,\n\nEntryEntry\022"
    "\013\n\003key\030\001 \001(\005\022\r\n\005value\030\002 \001(\005:\0028\001*\?\n\007MapEn"
    "um\022\020\n\014MAP_ENUM_FOO\020\000\022\020\n\014MAP_ENUM_BAR\020\001\022\020"
    "\n\014MAP_ENUM_BAZ\020\002B\'\370\001\001\252\002!Google.ProtocolB"
    "uffers.TestProtosb\006proto3", 5745);
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 13: {
        ...
        if (input->ExpectTag(106)) goto parse_loop_map_bool_bool;
        if (input->ExpectTag(114)) goto parse_loop_map_int32_enum;
        input->UnsafeDecrementRecursionDepth();
        break;
      }
      ...
      case 14: {
        ...
        if (input->ExpectTag(114)) goto parse_loop_map_int32_enum;
        if (input->ExpectTag(122)) goto parse_loop_map_int32_foreign_message;
        input->UnsafeDecrementRecursionDepth();
        break;
      }
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  for (;;) {
    ...
    if (!p.second) goto handle_unusual;
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      // map<int32, .protobuf_unittest.MessageContainingEnumCalledType> type = 1;
      case 1: {
        if (tag == 10) {
          DO_(input->IncrementRecursionDepth());
         parse_loop_type:
...
void MessageContainingEnumCalledType::SerializeWithCachedSizes(
  ...
  // map<int32, .protobuf_unittest.MessageContainingEnumCalledType> type = 1;
  {
    ...
    for (::google::protobuf::Map< ::google::protobuf::int32, ::protobuf_unittest::MessageContainingEnumCalledType >::const_iterator
        it = this->type().begin();
        it != this->type().end(); ++it) {
      if (entry.get() != NULL && entry->GetArena() != NULL) {
        entry.release();
...
void MessageContainingEnumCalledType::clear_type() {
 ...
 const ::google::protobuf::Map< ::google::protobuf::int32, ::protobuf_unittest::MessageContainingEnumCalledType >&
MessageContainingEnumCalledType::type() const {
 ...
 ::google::protobuf::Map< ::google::protobuf::int32, ::protobuf_unittest::MessageContainingEnumCalledType >*
