...
void protobuf_AddDesc_google_2fprotobuf_2fmap_5fproto2_5funittest_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "o\022 \n\034PROTO2_NON_ZERO_MAP_ENUM_FOO\020\001B$\252\002!"
    "Google.ProtocolBuffers.TestProtos", 1353);
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 101: {
        ...
        if (input->ExpectTag(810)) goto parse_loop_map_field;
        input->UnsafeDecrementRecursionDepth();
        if (input->ExpectAtEnd()) goto success;
        break;
      }
...
void TestEnumStartWithNonZeroMap::MergeFrom(const ::google::protobuf::Message& from) {
  ...
  const TestEnumStartWithNonZeroMap* source = 
      ::google::protobuf::internal::DynamicCastToGenerated<const TestEnumStartWithNonZeroMap>(
          &from);
  if (source == NULL) {
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
